func.func @main() {
    ...
    %host_mem_in = memref.alloc() : memref<10xf32>
    %host_mem_out = memref.alloc() : memref<10xf32>

    scf.for %i = %c0 to %c10 step %c1 {
        %val_i = arith.index_cast %i : index to i32
        %val = arith.sitofp %val_i : i32 to f32
        memref.store %val, %host_mem_in[%i] : memref<10xf32>
    }
    ...
    %unranked = memref.cast %host_mem_out : memref<10xf32> to memref<*xf32>
